...
packages/
  ...
  locales/           pptx-viewer-locales  - Internal reference dictionaries bundled into viewer locale subpaths
...
| **[pptx-viewer-locales](packages/locales/)**    | _(internal - not published)_                                                                                                        | Reference dictionaries bundled into the five viewers as optional `i18n/<locale>` imports.                                                                                            | [Contributing](packages/locales/README.md)  |
