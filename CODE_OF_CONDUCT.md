...
This project is maintained as a side project outside of full-time work (see
[SECURITY.md](SECURITY.md) for context on response times), by a single
maintainer rather than a dedicated conduct team. The maintainer is
responsible for clarifying and enforcing these standards and will take
...
[GitHub repository](https://github.com/ChristopherVR/pptx-viewer) - and also
...
[private GitHub security advisory](https://github.com/ChristopherVR/pptx-viewer/security/advisories/new)
...
fairly, and the maintainer is obligated to respect the privacy and security
