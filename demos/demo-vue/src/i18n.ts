 ...
 * Spanish, German, and Simplified Chinese resource bundles (the language picker in App.vue
...
const i18n = createI18n({
	...
	fallbackLocale: 'en',
	messages: {
		// translationsEn is pre-converted by the package; the demo's reference
		...
		'zh-CN': { ...toVueI18nSyntax(translationsZhCN), ...demoStringsZhCN },
	},
