...
.pptxv :is(button, [role='button']):not([role='switch']):not([data-pptx-compact]):not([data-pptx-backstage-nav-item]) { min-width: 24px; min-height: 24px; touch-action: manipulation; }
