...
import type { BoxTransform, InteractionBox, ResizeHandleId } from 'pptx-viewer-shared';
 ...
 * Pure math only (extraction candidates for `pptx-viewer-shared` once another
 * binding needs them).
 */
