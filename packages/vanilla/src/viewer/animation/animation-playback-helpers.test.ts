 ...
 * (controller-model) playback step helpers used by the vanilla-JS slide
 * show. Mirrors the coverage of the Vue / Svelte / Angular / React
 * equivalents; only the pure step-application logic is exercised here (the
 * clock lives in the presentation module that owns the timers).
 */
