...
/** Look up a canonical core preset by id (the six shared with the gallery). */
...
/** Wisp (gallery-only): copied from React BUILT_IN_THEMES. */
...
/** Berlin (gallery-only): copied from React BUILT_IN_THEMES. */
...
/** Slice (gallery-only): copied from React BUILT_IN_THEMES. */
...
/** Dividend (gallery-only): copied from React BUILT_IN_THEMES. */
