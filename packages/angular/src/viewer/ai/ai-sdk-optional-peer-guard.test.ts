 ...
 * user opens it.
 *
 * Unlike React/Vue/Svelte, this binding has no `@ai-sdk/angular` package to
...
describe('no static value import of the optional ai peer in packages/angular/src/viewer/ai', () => {
