...
/** Write (or clean up) the `a:effectLst` child: shadow, glow, soft edge, reflection, blur. */
function writeEffectList(spPr: XmlObject, shapeStyle: ShapeStyle, ctx: ShapeEffectsContext): void {
	const {
		outerShadowXml,
		presetShadowXml,
		innerShadowXml,
