...
export const ENGINE_FIRST_LAYOUT_IDS: ReadonlySet<string> = new Set([
	...
	'urn:microsoft.com/office/officeart/2024/layout/MeetTheTeam', // Meet The Team (legacy<=49.7924 -> engine<=0.7505)
	'urn:microsoft.com/office/officeart/2024/layout/MeetTheTeamCardVertical', // Meet The Team Card Vertical (legacy<=49.7924 -> engine<=0.758)
	'urn:microsoft.com/office/officeart/2024/layout/MeetTheTeamOval', // Meet The Team Oval (legacy<=49.7693 -> engine<=0.8274)
