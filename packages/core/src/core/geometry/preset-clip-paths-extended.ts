...
export const CLIP_PATHS_EXTENDED: Record<string, string | undefined> = {
  ...
  horizontalscroll:
    "polygon(0% 10%, 90% 0%, 100% 0%, 100% 90%, 10% 100%, 0% 100%)",
  irregularseal1:
  ...
  rightbracket:
    "polygon(60% 0%, 90% 0%, 100% 10%, 100% 90%, 90% 100%, 60% 100%)",
  bracepair:
  ...
  // ── Callouts ──────────────────────────────────────────────────────────
  wedgerectcallout:
    "polygon(0% 0%, 100% 0%, 100% 75%, 50% 75%, 30% 100%, 40% 75%, 0% 75%)",
  ...
  flowchartdocument:
    "polygon(0% 0%, 100% 0%, 100% 80%, 75% 90%, 50% 80%, 25% 90%, 0% 80%)",
  ...
  flowchartpreparation:
    "polygon(17% 0%, 83% 0%, 100% 50%, 83% 100%, 17% 100%, 0% 50%)",
