...
const E2E_FIXTURES: readonly FixtureEntry[] = [
	...
	},
	{
		...
		status: 'roundtrip',
		note:
			'Generated by generate-chart-stacked-line-markers-fixture.ts: a stacked line chart ' +
			'with bare major gridlines, non-sequential series indices and an 18pt legend font. ' +
			'Used by chart-stacked-line-markers.spec.ts.',
	},
	{
