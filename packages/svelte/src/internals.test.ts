/**
 * Export-surface test for `pptx-svelte-viewer/internals` (issue #290).
 *
 * A consumer embedding their own presentation stage needs the framework-
 * neutral slide-transition resolver/keyframes and the overlay component that
 * calls them, without reaching into `pptx-viewer-shared` (a private,
...
describe('pptx-svelte-viewer/internals: slide-transition helpers', () => {
	...
	it('exports the presentation-mode transition overlay component', () => {
