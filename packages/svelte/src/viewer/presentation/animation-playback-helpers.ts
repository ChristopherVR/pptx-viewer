 ...
 * a {@link PresentationAnimationController} during a Svelte slide show. Ported
 * from the Vue binding's `animation-playback-helpers` (itself a port of React's
 * `presentation-mode/animation-helpers` + `build-playback`).
 *
 ...
 * Mirrors the Vue / React `applyAnimationGroupSteps`.
 */
 ...
 * ordinary click-advance is unchanged. Mirrors the Vue / React `driveBuildReveal`.
 */
 ...
 * groups. Mirrors the Vue / React `scheduleAutoAdvanceChain`.
 */
