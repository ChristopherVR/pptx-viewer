<script lang="ts">
	 ...
	 * smartArt, media, ink, and ole. The remaining types (contentPart, zoom,
	 * model3d, unknown) render a typed placeholder; add a component + branch
	 * here to port one for real.
	 */
