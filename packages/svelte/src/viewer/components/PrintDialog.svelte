...
<div class="backdrop">
	...
	<section role="dialog" tabindex="-1" aria-modal="true" aria-label={t('pptx.print.title')}>
		<header><h2>▧ {t('pptx.print.title')}</h2><button onclick={onclose}>×</button></header>
		<div class="body">
