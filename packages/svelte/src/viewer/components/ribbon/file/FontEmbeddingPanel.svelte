...
<div class="backdrop">
	...
	<div class="panel" role="dialog" aria-modal="true" aria-labelledby="pptx-svelte-fonts-title">
		...
		<div class="body">
			...
			<label class="toggle"><input type="checkbox" checked={enabled} onchange={(event) => ontoggle(event.currentTarget.checked)} /><span>{t('pptx.fonts.enableEmbedding')}</span></label>
