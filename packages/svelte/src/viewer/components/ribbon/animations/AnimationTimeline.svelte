<script lang="ts">
	...
	import { bookmarkTriggerPatch, buildAnimationTimelineRows, DIRECTION_VALUES, effectiveTimingCurve, listMediaBookmarkOptions, REPEAT_MODE_VALUES, schemaLabel, selectedBookmarkOptionValue, SEQUENCE_VALUES, TIMING_CURVE_VALUES, TRIGGER_VALUES } from 'pptx-viewer-shared';
