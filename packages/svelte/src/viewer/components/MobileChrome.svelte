...
<style>
	...
	@media (max-width: 767px), (max-width: 1023px) and (max-height: 520px) {
		...
		.pptx-svelte-mobile-toolbar button:hover:not(:disabled), .pptx-svelte-mobile-toolbar button:focus-visible { background: var(--pptx-accent, #33334d); }
		.pptx-svelte-mobile-toolbar button:focus-visible { outline: 2px solid var(--pptx-ring, #6366f1); outline-offset: -2px; }
