<script lang="ts">
	 ...
	 * active: a wedge facet has no 2D screen geometry to hit-test against.
	 *
	...
	async function mountScene(
		...
		const result = await mountPieChart3D(sceneHost, options);
...
{#if mounted}
	<div
		class="pptx-svelte-element pptx-svelte-pie-chart-3d"
