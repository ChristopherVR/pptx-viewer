...
| ------------------------- | --------------------------------------------------------------------------------------- |
| `pptx-viewer-mcp`         | 25 tool functions, the `PptxHandler` engine, provider types, and the execution pipeline |
| `pptx-viewer-mcp/schemas` | Zod schemas for every tool input                                                        |
| `pptx-viewer-mcp/codec`   | `PptxCodec`, the Y.Doc to PPTX bytes codec                                              |
| `pptx-viewer-mcp/mcp`     | `createServer()`, the programmatic MCP server factory                                   |
