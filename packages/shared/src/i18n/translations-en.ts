...
export const translationsEn: Record<string, string> = {
	...
	'pptx.chart.chartFilters': 'Chart filters',
	'pptx.chart.hideSeries': 'Hide {{name}}',
	'pptx.chart.showSeries': 'Show {{name}}',
	'pptx.chart.quickElements': 'Chart Elements',
	'pptx.chart.quickStyles': 'Chart Styles',
	'pptx.chart.quickFilters': 'Chart Filters',
	'pptx.chart.quickAxes': 'Axes',
	'pptx.chart.quickAxisTitles': 'Axis Titles',
	'pptx.chart.styleColorful': 'Colorful',
	'pptx.chart.styleMonochrome': 'Monochrome',
	'pptx.chart.styleColorfulLight': 'Colorful Light',
	'pptx.chart.styleColorfulDark': 'Colorful Dark',
	'pptx.chart.styleMutedDark': 'Muted Dark',
	'pptx.chart.stylePastel': 'Pastel',
	'pptx.chart.valueFromCells': 'Value from cells: {{name}}',
	...
	'pptx.shape.mergeShapes': 'Merge Shapes',
	'pptx.shape.mergeShapesHint': 'Select two or more shapes to merge them',
	'pptx.shape.mergeUnion': 'Union',
	'pptx.shape.mergeCombine': 'Combine',
	'pptx.shape.mergeFragment': 'Fragment',
	'pptx.shape.mergeIntersect': 'Intersect',
	'pptx.shape.mergeSubtract': 'Subtract',
	...
	'pptx.contextMenu.crop': 'Crop',
	'pptx.contextMenu.mergeUnion': 'Union Shapes',
	'pptx.contextMenu.mergeCombine': 'Combine Shapes',
	'pptx.contextMenu.mergeFragment': 'Fragment Shapes',
	'pptx.contextMenu.mergeIntersect': 'Intersect Shapes',
	'pptx.contextMenu.mergeSubtract': 'Subtract Shapes',
	...
	'pptx.ole.editContent': 'Edit content...',
	'pptx.ole.editDialog.title': 'Edit Embedded Object',
	'pptx.ole.editDialog.tabSheet': 'Spreadsheet',
	'pptx.ole.editDialog.tabDocument': 'Document',
	'pptx.ole.editDialog.tabDeck': 'Presentation',
	'pptx.ole.editDialog.tabFile': 'File',
	'pptx.ole.editDialog.replaceFile': 'Replace File...',
	'pptx.ole.editDialog.replaceFileHint': "Choose a new file to replace this object's content.",
	'pptx.ole.editDialog.save': 'Save',
	'pptx.ole.editDialog.cancel': 'Cancel',
	'pptx.ole.editDialog.emptyDocument': 'This document has no paragraphs to edit.',
	'pptx.ole.editDialog.emptySheet': 'No spreadsheet data could be read from this object.',
	'pptx.ole.editDialog.deckSlideLabel': 'Slide {{number}}',
	'pptx.ole.editDialog.deckEmpty': 'This embedded presentation has no slides.',
	'pptx.ole.editDialog.unsupported':
		"This object's content can't be edited directly here. Use Replace File to update it.",
	'pptx.ole.editDialog.cellEditLabel': 'Cell value',
	'pptx.ole.editDialog.loading': 'Loading content...',
	'pptx.ole.editDialog.saveError': 'Could not save the change.',
	...
	'pptx.contextMenu.editPoints': 'Edit Points',
	'pptx.editPoints.addPoint': 'Add Point',
	'pptx.editPoints.closePath': 'Close Path',
	'pptx.editPoints.cornerPoint': 'Corner Point',
	'pptx.editPoints.curvedSegment': 'Curved Segment',
	'pptx.editPoints.deletePoint': 'Delete Point',
	'pptx.editPoints.deleteSegment': 'Delete Segment',
	'pptx.editPoints.exit': 'Exit Edit Points',
	'pptx.editPoints.menu': 'Edit Points commands',
	'pptx.editPoints.openPath': 'Open Path',
	'pptx.editPoints.overlay': 'Edit points of the selected shape',
	'pptx.editPoints.smoothPoint': 'Smooth Point',
	'pptx.editPoints.straightPoint': 'Straight Point',
	'pptx.editPoints.straightSegment': 'Straight Segment',
	'pptx.freeformTool.overlay': 'Click to add points; double-click or press Enter to finish',
	...
	'pptx.animation.sound.other': 'Other Sound...',
	'pptx.animation.sound.preview': 'Preview sound',
	// PowerPoint's 19 built-in stock sounds (Animation Effect Options > Sound
	// and Transitions > Sound share this same gallery).
	'pptx.animation.sound.applause': 'Applause',
	'pptx.animation.sound.arrow': 'Arrow',
	'pptx.animation.sound.bomb': 'Bomb',
	'pptx.animation.sound.breeze': 'Breeze',
	'pptx.animation.sound.camera': 'Camera',
	'pptx.animation.sound.cashRegister': 'Cash Register',
	'pptx.animation.sound.chime': 'Chime',
	'pptx.animation.sound.click': 'Click',
	'pptx.animation.sound.coin': 'Coin',
	'pptx.animation.sound.drumRoll': 'Drum Roll',
	'pptx.animation.sound.explosion': 'Explosion',
	'pptx.animation.sound.hammer': 'Hammer',
	'pptx.animation.sound.laser': 'Laser',
	'pptx.animation.sound.push': 'Push',
	'pptx.animation.sound.suction': 'Suction',
	'pptx.animation.sound.typewriter': 'Typewriter',
	'pptx.animation.sound.voltage': 'Voltage',
	'pptx.animation.sound.whoosh': 'Whoosh',
	'pptx.animation.sound.wind': 'Wind',
	...
	'pptx.image.crop': 'Crop',
	'pptx.image.cropToAspectRatio': 'Crop to Aspect Ratio',
	'pptx.image.cropFill': 'Fill',
	'pptx.image.cropFit': 'Fit',
	'pptx.image.cropSquare': 'Square',
	'pptx.image.cropPortrait': 'Portrait',
	'pptx.image.cropLandscape': 'Landscape',
	'pptx.image.cropHandle': 'Crop handle',
	'pptx.image.cropModeHint':
		'Drag the black handles to crop. Press Enter to apply or Esc to cancel.',
	'pptx.image.cropHint': 'Select a picture to crop it',
	...
	'pptx.options.general.showMiniToolbarInfo':
		'Shows the floating formatting toolbar when you select text.',
	'pptx.options.general.enableLivePreview': 'Enable Live Preview',
	'pptx.options.general.enableLivePreviewInfo':
		'Previews formatting changes on the slide as you hover over gallery choices.',
	...
	'pptx.options.proofing.autoCorrectDescription':
		'Change how text is corrected and formatted as you type.',
	...
	'pptx.options.save.autoSaveInfo':
		'Snapshots are stored locally and offered for recovery when you reopen.',
	...
	'pptx.options.save.clearCacheOnClose':
		'Delete files from the local document cache when they are closed',
	'pptx.options.save.clearCacheNow': 'Delete cached files',
	'pptx.options.save.clearCacheDescription':
		'Deletes locally stored recovery snapshots and recent files. This does not affect the open presentation.',
	...
	'pptx.options.language.displayLanguageDescription':
		'Buttons, menus, and other controls will show in the selected language.',
	...
	'pptx.options.ribbon.tabsDescription':
		'Untick a tab to hide it from the ribbon. The File tab is always shown.',
	...
	'pptx.options.addIns.smartArt3dDescription':
		'Opt-in three.js renderer for extruded and spatial SmartArt layouts.',
	...
	'pptx.options.trust.settingsDescription':
		'These settings help keep the content you open safe. We recommend the defaults.',
	'pptx.options.trust.protectedView': 'Open presentations in Protected View',
	'pptx.options.trust.protectedViewInfo':
		'Documents open read-only; use Enable Editing to make changes.',
