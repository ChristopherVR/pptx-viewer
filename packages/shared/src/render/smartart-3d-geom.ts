...
// Colour parsing and contrast picking are shared with the 2D cached-shape
// renderer; see `color-contrast`. Re-exported here so the existing 3D imports
// keep resolving from one place.
export { parseHex, contrastTextColor } from './color-contrast';
