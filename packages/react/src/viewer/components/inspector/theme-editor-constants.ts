// ---------------------------------------------------------------------------
// Shared style tokens for the theme editor components
// ---------------------------------------------------------------------------

export const THEME_EDITOR_CARD = "rounded bg-muted/50 p-2.5 space-y-2";

export const THEME_EDITOR_HEADING =
  "text-[11px] font-medium uppercase tracking-wide text-muted-foreground mb-1.5";

export const THEME_EDITOR_INPUT =
