 ...
 * (controller-model) playback step helpers used by the Vue slide show. Mirrors
 * the coverage of the Angular `presentation-playback-helpers` and React
 * `animation-helpers` tests; only the pure step-application logic is
 * exercised here (the clock lives in the composable that owns the timers).
 */
