...
import { generateTicks, PX_PER_INCH, RULER_THICKNESS } from './ruler-utils';

describe('generateTicks', () => {
	it('places a major numbered tick every inch at 1× scale', () => {
		// A 10-inch-wide slide at scale 1.
		...
		// Inch 3 sits at 3 inch × 96px × scale 1.
