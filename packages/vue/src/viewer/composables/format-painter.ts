 ...
 * applies them to another. Pure, framework-agnostic logic (Vue-local port of
 * the React `viewer/utils/format-painter.ts`; extraction into
 * `pptx-viewer-shared` is a follow-up).
 */
