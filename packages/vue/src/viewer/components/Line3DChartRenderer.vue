 ...
 * drag to rotate, scroll to zoom; click a marker to select it, drag one to
 ...
 * in {@link useLineChart3dScene}; this SFC stays thin presentation. Mirrors
...
const { mounted, loading, dragLabel } = useLineChart3dScene({
