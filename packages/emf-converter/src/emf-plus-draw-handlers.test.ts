...
describe('emf-plus-draw-handlers', () => {
	describe('handleEmfPlusDrawRecord()', () => {
		it('is a function with arity 5', () => {
			expectTypeOf(handleEmfPlusDrawRecord).toBeFunction();
			expect(handleEmfPlusDrawRecord).toHaveLength(5);
		});
		...
		describe('eMFPLUS_DRAWLINES', () => {
			it('draws compressed line segments', () => {
				...
				rCtx.view.setInt16(d + 4, 0, true);
				rCtx.view.setInt16(d + 6, 0, true);
				rCtx.view.setInt16(d + 8, 50, true);
				rCtx.view.setInt16(d + 10, 50, true);
				rCtx.view.setInt16(d + 12, 100, true);
				rCtx.view.setInt16(d + 14, 0, true);
			...
			it('closes path when flag 0x2000 is set', () => {
				...
				rCtx.view.setInt16(d + 6, 0, true);
				rCtx.view.setInt16(d + 8, 10, true);
				rCtx.view.setInt16(d + 10, 10, true);
		...
		describe('eMFPLUS_FILLPOLYGON', () => {
			it('fills a compressed polygon', () => {
				...
				rCtx.view.setInt16(d + 12, 50, true);
				rCtx.view.setInt16(d + 14, 0, true);
				rCtx.view.setInt16(d + 16, 25, true);
				rCtx.view.setInt16(d + 18, 50, true);
