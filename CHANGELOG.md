...
- **vue:** Ribbon style galleries, contextual tabs and group customisation (by @ChristopherVR) ([7170181](https://github.com/ChristopherVR/pptx-viewer/commit/7170181bf4e62eb676cec2287b4c4f8a410fa1c7))
- **angular:** Ribbon style galleries, contextual tabs and group customisation (by @ChristopherVR) ([127100f](https://github.com/ChristopherVR/pptx-viewer/commit/127100fce46b653be3387825fa7dc91d33d71127))
...
- **vanilla:** Ribbon style galleries, contextual tabs and group customisation (by @ChristopherVR) ([5a9a9da](https://github.com/ChristopherVR/pptx-viewer/commit/5a9a9da9859e24e083924cee7e1926835cce22af))
...
- **vue:** Offer PowerPoint's directions and preview from its tree (by @ChristopherVR) ([90383c8](https://github.com/ChristopherVR/pptx-viewer/commit/90383c8a01e97e32db20d4c7f13e651c1f895696))
- **angular:** Offer PowerPoint's directions and preview from its tree (by @ChristopherVR) ([1f8ebd1](https://github.com/ChristopherVR/pptx-viewer/commit/1f8ebd11b7c15d346227f2f5a7cdf699b8dfff26))
...
- **vanilla:** Offer PowerPoint's directions for each preset (by @ChristopherVR) ([617c304](https://github.com/ChristopherVR/pptx-viewer/commit/617c304018759a5b49b018b044eb8d61cca9e6a9))
...
- **vanilla:** Browse Themes and Edit Theme change the presentation theme (by @ChristopherVR) ([d17caab](https://github.com/ChristopherVR/pptx-viewer/commit/d17caabe2879f026b8896b4afcc5b60b64e25d56))
- **angular:** Escape clears the selection once no chrome is left to close (by @ChristopherVR) ([76edabb](https://github.com/ChristopherVR/pptx-viewer/commit/76edabb0e4e55a292df63e93502d5c1900a48fa8))
- **vanilla:** Mount gallery popups and contextual panes only while shown (by @ChristopherVR) ([4a288ab](https://github.com/ChristopherVR/pptx-viewer/commit/4a288abe49c13cd6c9c5ebd9989368fe68483a48))
...
- **guide:** Close the cjk and chart-label gaps in limitations (by @ChristopherVR) ([9d83d5a](https://github.com/ChristopherVR/pptx-viewer/commit/9d83d5af86b2cfc45c90fa302939f6bcd9cab13b))
- **guide:** Record the save-residue and .ppt master fixes; sync translations (by @ChristopherVR) ([a0b631c](https://github.com/ChristopherVR/pptx-viewer/commit/a0b631ce80fb62a2040f670afcc50875e11f084b))
- **guide:** Document ribbon group and control customisation (by @ChristopherVR) ([8a14b54](https://github.com/ChristopherVR/pptx-viewer/commit/8a14b54e23270b80172bf925361af1e4c0dc9e1e))
- **guide:** List which ribbon galleries ship and which are still missing (by @ChristopherVR) ([ecc6354](https://github.com/ChristopherVR/pptx-viewer/commit/ecc635485cc043603f711900d3ebdbf0179827d0))
...
- **guide:** Record behaviour-tree playback and direction saving (by @ChristopherVR) ([ab5ad64](https://github.com/ChristopherVR/pptx-viewer/commit/ab5ad64c6a89cf3283623aac258531ee6163fb50))

### Testing

- **e2e:** Keep the slow cross-binding GIF resolution test off hosted CI (by @ChristopherVR) ([f5dba83](https://github.com/ChristopherVR/pptx-viewer/commit/f5dba8342ff2bf4d4c60daf01061d91f8b857207))
...
- **e2e:** Ribbon galleries and group customisation in all five bindings (by @ChristopherVR) ([9c4dca8](https://github.com/ChristopherVR/pptx-viewer/commit/9c4dca8fc1937521496e6dbf682ae82508e7ff0b))
...
- **e2e:** Read the wipe mask direction from its computed gradient (by @ChristopherVR) ([c566acf](https://github.com/ChristopherVR/pptx-viewer/commit/c566acfac825a77f59bbba028001466cf73a3c3c))
- **vanilla:** Give full-viewer unit tests a 30s timeout like core and svelte (by @ChristopherVR) ([179ec80](https://github.com/ChristopherVR/pptx-viewer/commit/179ec8039096f8c607e35d4b29a1479b9b6e1926))
...
_Releases: pptx-viewer-core@4.5.0, pptx-react-viewer@4.8.0, pptx-vue-viewer@4.8.0, pptx-angular-viewer@4.8.0, pptx-vanilla-viewer@3.8.0, pptx-svelte-viewer@4.8.0, @christophervr/pptx-viewer@2.29.1_
...
- **angular:** Bind smartart drawing fill-opacity (by @claude) ([404539c](https://github.com/ChristopherVR/pptx-viewer/commit/404539c23543b0775fa97640b72a2c78e8575aa0))
- **svelte:** Bind smartart drawing fill-opacity (by @claude) ([e304314](https://github.com/ChristopherVR/pptx-viewer/commit/e3043149af8946be386d09c1b840b9f609359870))
- **vanilla:** Bind smartart drawing fill-opacity (by @claude) ([7e681a0](https://github.com/ChristopherVR/pptx-viewer/commit/7e681a0d09301102810366af80812fe950722e0a))
...
- Narrow the text and chart gaps in the limitations guide (by @ChristopherVR) ([03a6d9e](https://github.com/ChristopherVR/pptx-viewer/commit/03a6d9e44588b74565ad3bf87d3d9f5ab6b259a4))
- Record the measured wordart can interior outline error (by @ChristopherVR) ([691dbb2](https://github.com/ChristopherVR/pptx-viewer/commit/691dbb26145ef02e69c1ae789441a12bf00619e1))
- Update the wordart envelope row with the measured can numbers (by @ChristopherVR) ([52fcf31](https://github.com/ChristopherVR/pptx-viewer/commit/52fcf318ca3f159bad23a89cf7ec8f8945510503))
...
- **guide:** Update the .ppt export, save and playback rows after this wave (by @ChristopherVR) ([8e11158](https://github.com/ChristopherVR/pptx-viewer/commit/8e111582d1b6ffc35b13c8fa3bd4c493aa9ec79c))
- Record the title band and SmartArt 3D save in the parity status (by @claude) ([7ce422c](https://github.com/ChristopherVR/pptx-viewer/commit/7ce422c4782cbb91eb170571e05301eb3d78c0ab))
- Mark the 3D smoke spec and html2canvas export verified (by @claude) ([d311363](https://github.com/ChristopherVR/pptx-viewer/commit/d3113638ce889858c588dbb4b64d224af37d9572))
- Record SmartArt bevel and scene style parity in the 3D harness (by @claude) ([d915d53](https://github.com/ChristopherVR/pptx-viewer/commit/d915d53f425fdb71d3b6bab3818b9dce48c674e1))
- **demo:** Mark smartart structural-edit 3d round-trip done (by @claude) ([27ca13d](https://github.com/ChristopherVR/pptx-viewer/commit/27ca13d82b9f461212ddf534308037af617de632))
- Record smartart pyramid and venn flat-path parity in the 3d harness (by @claude) ([f51d11d](https://github.com/ChristopherVR/pptx-viewer/commit/f51d11d8c4092b08f52142e4778969df5282c31d))
- Record the SmartArt 3D follow-ups in the parity harness (by @claude) ([fb7b92e](https://github.com/ChristopherVR/pptx-viewer/commit/fb7b92e78111865b08942817d2b24b8c5995ae69))
- **guide:** Record the .ppt encryption and svg fixes; sync two bullets (by @ChristopherVR) ([c4851c6](https://github.com/ChristopherVR/pptx-viewer/commit/c4851c6eb4529c8d5e048ceb3152f791ff199828))
...
- Add wordart can com measurement scripts (by @ChristopherVR) ([9f1670e](https://github.com/ChristopherVR/pptx-viewer/commit/9f1670e9c3a6d1c8cee68c43858d42ab519564f2))
...
- **e2e:** Walk every 3D chart and export it in every binding (by @claude) ([2e17799](https://github.com/ChristopherVR/pptx-viewer/commit/2e177994d0f262fe30e1175fdde7f8e8745a6d7f))
- **e2e:** Check smartart pyramid tiers and venn alpha in every binding (by @claude) ([5f4895b](https://github.com/ChristopherVR/pptx-viewer/commit/5f4895bd6d3151b808ddb912cf70f13c6f8a3545))
...
- **e2e:** Check a turned 3D SmartArt draws past its frame in every binding (by @claude) ([f30be4b](https://github.com/ChristopherVR/pptx-viewer/commit/f30be4bb2d1809545cae331863114e240e131763))
- **e2e:** Read the 3D chart hover tooltip from the view's pointer layer (by @claude) ([07b8016](https://github.com/ChristopherVR/pptx-viewer/commit/07b8016dc1f3332cd90a4c9905ffba7fa8d1890d))
- **angular:** Expect the window slide keyframe for the slide filter (by @ChristopherVR) ([ea9f030](https://github.com/ChristopherVR/pptx-viewer/commit/ea9f030e0c66a1253e77532a67a069036390549a))
...
_Releases: pptx-viewer-core@4.4.0, pptx-react-viewer@4.7.0, pptx-vue-viewer@4.7.0, pptx-angular-viewer@4.7.0, pptx-vanilla-viewer@3.7.0, pptx-svelte-viewer@4.7.0, @christophervr/pptx-viewer@2.29.0_
...
- **angular:** Edit points and freeform shape / curve tools (by @ChristopherVR) ([39ca9cd](https://github.com/ChristopherVR/pptx-viewer/commit/39ca9cd839c4ab3cbe6da1f6454bb6d104705950))
- **vue:** Edit points and freeform shape / curve tools (by @ChristopherVR) ([904b838](https://github.com/ChristopherVR/pptx-viewer/commit/904b838a13dda3ec6fa30f628a7f2191f9d0e659))
- **svelte:** Edit points and freeform shape / curve tools (by @ChristopherVR) ([7cf4b10](https://github.com/ChristopherVR/pptx-viewer/commit/7cf4b10cad8880541aa568037baa753d8c4ccab3))
- **vanilla:** Edit points and freeform shape / curve tools (by @ChristopherVR) ([715dc69](https://github.com/ChristopherVR/pptx-viewer/commit/715dc698c5a70ecac92b86a56a9f26556a377c41))
...
- **svelte:** Merge shapes and on-canvas picture crop (by @ChristopherVR) ([46018ee](https://github.com/ChristopherVR/pptx-viewer/commit/46018eed08d29372ce09ee9b1e8fa6b4c8811e50))
- **angular:** Merge shapes and on-canvas picture crop (by @ChristopherVR) ([d1920ef](https://github.com/ChristopherVR/pptx-viewer/commit/d1920ef66c3f551c631813d26ec247e27bd59513))
- **vue:** Merge shapes and on-canvas picture crop (by @ChristopherVR) ([29a22f0](https://github.com/ChristopherVR/pptx-viewer/commit/29a22f0ad5d5befe28f4ed80e81a8f6346fa8ad6))
- **vanilla:** Merge shapes and on-canvas picture crop (by @ChristopherVR) ([14ab278](https://github.com/ChristopherVR/pptx-viewer/commit/14ab27843aaa73cea8b00d03e6328a8dc37b7624))
...
- **vue:** Pick the media bookmark for an On bookmark trigger (by @ChristopherVR) ([635c1ba](https://github.com/ChristopherVR/pptx-viewer/commit/635c1bafb186cd1210234525f8e85fbd523a40e6))
- **angular:** Pick the media bookmark for an On bookmark trigger (by @ChristopherVR) ([a9caeb3](https://github.com/ChristopherVR/pptx-viewer/commit/a9caeb323a22211e7a080475c42285aca1d9b122))
- **svelte:** Pick the media bookmark for an On bookmark trigger (by @ChristopherVR) ([585be2e](https://github.com/ChristopherVR/pptx-viewer/commit/585be2e82938b7debb4019311868acda9c93a85d))
- **vanilla:** Pick the media bookmark for an On bookmark trigger (by @ChristopherVR) ([2fcee92](https://github.com/ChristopherVR/pptx-viewer/commit/2fcee92be7e9422cf4140d0c909b97d24420553c))
...
- **vue,docs:** Merge Edit Points and picture crop wiring cleanly (by @ChristopherVR) ([b620d25](https://github.com/ChristopherVR/pptx-viewer/commit/b620d25260d3e54de6e092cd1ffbfcd46091c63c))
...
- **vue:** Accept the shared crop cancel update type (by @ChristopherVR) ([2a8bc46](https://github.com/ChristopherVR/pptx-viewer/commit/2a8bc46efe3f7ed043cb755a57b3ec82de269623))
- **svelte:** Accept the shared crop cancel update type (by @ChristopherVR) ([8016412](https://github.com/ChristopherVR/pptx-viewer/commit/80164126042dad7180dba6cbc7f50f60f4f14502))
- **vanilla:** Accept the shared crop cancel update type (by @ChristopherVR) ([5a117a4](https://github.com/ChristopherVR/pptx-viewer/commit/5a117a45c79e09d0c7554f3de2627d3b5d2eaf3b))
...
- Drop edit points from the editor coverage gaps (by @ChristopherVR) ([e107f5e](https://github.com/ChristopherVR/pptx-viewer/commit/e107f5e92b4be72779ccc936552868e46fe17a50))
- Drop merge shapes and crop handles from the editor gaps (by @ChristopherVR) ([67c68fa](https://github.com/ChristopherVR/pptx-viewer/commit/67c68fa9697a81c48c345ede99f6d7e18f5738db))
...
- Narrow the animation and save-residue limitations to what is open (by @ChristopherVR) ([1cb7c28](https://github.com/ChristopherVR/pptx-viewer/commit/1cb7c28f49208561779daf8896edaf3d03c59a2c))
...
- Narrow the open text and chart gaps in the limitations guide (by @ChristopherVR) ([d68a869](https://github.com/ChristopherVR/pptx-viewer/commit/d68a86939cb16117dd3aa402b6650a1753c651c3))
- Sync the translated limitations pages with the English (by @ChristopherVR) ([80e9826](https://github.com/ChristopherVR/pptx-viewer/commit/80e982621a7ecf3a420dbbf8f39ad0741d00e867))

### Testing

- **e2e:** Cover edit points and the freeform / curve tools (by @ChristopherVR) ([b2d18fa](https://github.com/ChristopherVR/pptx-viewer/commit/b2d18fa4bb53b8117266bb7f48466a113bcfbcdc))
...
- **e2e:** Check the u="words" gap by the space inside the run (by @ChristopherVR) ([f95b0de](https://github.com/ChristopherVR/pptx-viewer/commit/f95b0deb52a53bfe1c3d6ec625999811fc458844))
...
- **e2e:** Import stageElements from the context-menu support module (by @ChristopherVR) ([0963495](https://github.com/ChristopherVR/pptx-viewer/commit/09634955e1cdbb47522c60fde30edf4d867120f3))

## 2026-09-24

_Releases: pptx-viewer-core@4.2.0, pptx-react-viewer@4.3.0, pptx-vue-viewer@4.3.0, pptx-angular-viewer@4.3.0, pptx-vanilla-viewer@3.3.0, pptx-svelte-viewer@4.3.0, @christophervr/pptx-viewer@2.25.0_
...
- **vue:** Wire the fullScrn full-slide media overlay (by @ChristopherVR) ([717ba11](https://github.com/ChristopherVR/pptx-viewer/commit/717ba1141a13d872131d155d736bdad86089921e))
- **svelte:** Wire the fullScrn full-slide media overlay (by @ChristopherVR) ([066addc](https://github.com/ChristopherVR/pptx-viewer/commit/066addc7e6d6077f94eb7f45b607ecda15c425fb))
- **vanilla:** Wire the fullScrn full-slide media overlay (by @ChristopherVR) ([7f5e392](https://github.com/ChristopherVR/pptx-viewer/commit/7f5e39203d2a2c7ea97b922dc5f0186810d8053a))
...
- **vanilla:** Wire PowerPoint editor shortcuts via the shared keymap (by @ChristopherVR) ([a352f98](https://github.com/ChristopherVR/pptx-viewer/commit/a352f98d3ff8b7f3df157f2c3ef4b2eeae5a6ac5))
...
- **vue:** Wire PowerPoint editor shortcuts via the shared keymap (by @ChristopherVR) ([483bb17](https://github.com/ChristopherVR/pptx-viewer/commit/483bb1719151734ea1479db3e8fe887bbca5104c))
- **svelte:** Wire PowerPoint editor shortcuts via the shared keymap (by @ChristopherVR) ([f58839d](https://github.com/ChristopherVR/pptx-viewer/commit/f58839d6d8b2cc02167d78a2e8e5457608627f9a))
...
- **vue:** Apply highlighter mix-blend-mode per stroke, not per element (by @ChristopherVR) ([2485981](https://github.com/ChristopherVR/pptx-viewer/commit/24859812f894ed38de49061aac9e32cbec06dffb))
...
- **svelte:** Apply highlighter mix-blend-mode per stroke, not per element (by @ChristopherVR) ([cd41fe3](https://github.com/ChristopherVR/pptx-viewer/commit/cd41fe30cd345c09819dfa07414e0b9977725d0c))
- **vanilla:** Apply highlighter mix-blend-mode per stroke, not per element (by @ChristopherVR) ([e910b68](https://github.com/ChristopherVR/pptx-viewer/commit/e910b68df08c16b8ba69d547447081b4a7033abc))
...
- **demos:** Stop Vite pre-bundling emf-converter in all five demos (by @ChristopherVR) ([fc857b8](https://github.com/ChristopherVR/pptx-viewer/commit/fc857b861716593aaf29363510869b30c6cebd8f))
...
- **guide:** Restate the smartart limitation with measured numbers (by @ChristopherVR) ([2790a15](https://github.com/ChristopherVR/pptx-viewer/commit/2790a1596f14c8c03b6b82e724c170d727c94a78))
- **guide:** Record the 2026-09 audit gaps and wave results in limitations (by @ChristopherVR) ([7c3ef2e](https://github.com/ChristopherVR/pptx-viewer/commit/7c3ef2e7b1d84811869ca965bbe28801fa879191))
- **guide:** Restate the wordart limitation after the can spacing fix (by @ChristopherVR) ([cfd7fe3](https://github.com/ChristopherVR/pptx-viewer/commit/cfd7fe30942c0d61611070d502e79ef2167bbad4))
- **guide:** Point the emf rows at emf-converter 3.1.0 (by @ChristopherVR) ([4af7302](https://github.com/ChristopherVR/pptx-viewer/commit/4af73029e662237ccd2384e9f4f551bd7a5fa06c))
- Document the .ppt metroBlob round-trip and sync stale pages (by @ChristopherVR) ([a38513c](https://github.com/ChristopherVR/pptx-viewer/commit/a38513c018f88c0516066497fa2e8f23b149bd1d))
- **guide:** Restate the smartart row with the engine's measured numbers (by @ChristopherVR) ([1fa3fff](https://github.com/ChristopherVR/pptx-viewer/commit/1fa3fff25fe883ae24313aba027539eeb63cc35a))
- **guide:** Narrow the saved-animation limitation to the remaining presets (by @ChristopherVR) ([58109b7](https://github.com/ChristopherVR/pptx-viewer/commit/58109b7446c11565e182726ba7145eec49b22f87))
- **guide:** Update the emf rows for emf-converter 3.2.0 (by @ChristopherVR) ([2ef797a](https://github.com/ChristopherVR/pptx-viewer/commit/2ef797af14aaa1d6d17bdb67813048922b81973b))
- **guide:** Update animation gaps after bounce, bookmark and subtype fixes (by @ChristopherVR) ([f3a264a](https://github.com/ChristopherVR/pptx-viewer/commit/f3a264ae291229ae86fad85864dd77d73f4c24bc))
- **guide:** Update the emf rows for emf-converter 3.3.0 (by @ChristopherVR) ([7ecde55](https://github.com/ChristopherVR/pptx-viewer/commit/7ecde5548b644803c9e4f4100d4b45bba8624121))

### Testing

- **e2e:** Add framework-neutral highlighter blend-mode spec (by @ChristopherVR) ([c8c3968](https://github.com/ChristopherVR/pptx-viewer/commit/c8c3968cd13249035812f2beb7ef9fe47ff2f874))
...
- **e2e:** Add a framework-neutral spec for the new PowerPoint shortcuts (by @ChristopherVR) ([3378ecf](https://github.com/ChristopherVR/pptx-viewer/commit/3378ecfa71de410a8829fd873630f10bdf70bedf))
...
_Releases: pptx-viewer-core@4.1.0, pptx-react-viewer@4.2.0, pptx-vue-viewer@4.2.0, pptx-angular-viewer@4.2.0, pptx-vanilla-viewer@3.2.0, pptx-svelte-viewer@4.2.0, @christophervr/pptx-viewer@2.24.0_
...
- **svelte:** Render 3D charts and SmartArt through <pptx-three-view> (by @claude) ([b384697](https://github.com/ChristopherVR/pptx-viewer/commit/b384697c8637b0d961c2dc4c8e38a1d0af217084))
...
- **angular:** Render 3D charts and SmartArt through <pptx-three-view> (by @claude) ([3b48e3a](https://github.com/ChristopherVR/pptx-viewer/commit/3b48e3a753b709da92e51d1b6a4bff0f18887287))
...
- Record the 3D parity programme status and next steps (by @ChristopherVR) ([244cee9](https://github.com/ChristopherVR/pptx-viewer/commit/244cee9f20c494dc2e31e7b50d577e82c6d1516f))
- Update the 3D parity status now all five bindings use the element (by @claude) ([49adff0](https://github.com/ChristopherVR/pptx-viewer/commit/49adff056806865ff51e4df1db988ab5dbf0079d))

### Testing

- **e2e:** Add PowerPoint ground truth and a 3D parity harness (by @ChristopherVR) ([10f6fa2](https://github.com/ChristopherVR/pptx-viewer/commit/10f6fa214c77bed1e5df16a687b535de68bf8dac))
...
- **vue:** Chart quick-action icons (Elements/Styles/Filters) (by @ChristopherVR) ([b6ba47e](https://github.com/ChristopherVR/pptx-viewer/commit/b6ba47ed06580a8b0cf66d7bf16b51641bab9cc4))
- **angular:** Chart quick-action icons (Elements/Styles/Filters) (by @ChristopherVR) ([4acdcd8](https://github.com/ChristopherVR/pptx-viewer/commit/4acdcd8c4239b5e796b457c92cb1fa68b6833e88))
- **svelte:** Chart quick-action icons (Elements/Styles/Filters) (by @ChristopherVR) ([d7b0e12](https://github.com/ChristopherVR/pptx-viewer/commit/d7b0e12f5cf98d7c9a1f7570c67e4667518c13f6))
- **vanilla:** Chart quick-action icons (Elements/Styles/Filters) (by @ChristopherVR) ([1195c36](https://github.com/ChristopherVR/pptx-viewer/commit/1195c36963edfe3db2fa705bcee66b279d66a4cc))
...
- **vanilla:** Retain inline focus during peer updates (by @Sudhansh6) ([a9a7548](https://github.com/ChristopherVR/pptx-viewer/commit/a9a75485c08f46dc6a5187371bafcac766cd512c))
...
- **e2e:** Assert the chart title on the page, not inside the chart element (by @ChristopherVR) ([40ae008](https://github.com/ChristopherVR/pptx-viewer/commit/40ae008ad7ffaf36c39af255e12661eedf0c4638))
...
- **ci:** Disable GPU compositing to stop Chromium crashes in e2e (by @ChristopherVR) ([7f29145](https://github.com/ChristopherVR/pptx-viewer/commit/7f291455a548c26df9155b75602f2efb03d9cf32))
...
- **e2e:** Framework-neutral spec for gridlines/marker-cycle/legend-font (by @ChristopherVR) ([d14e373](https://github.com/ChristopherVR/pptx-viewer/commit/d14e37365d51f998670451adecb43a35ce63feb7))
- **e2e:** Framework-neutral spec for chart quick-actions (by @ChristopherVR) ([9d78c89](https://github.com/ChristopherVR/pptx-viewer/commit/9d78c8978398828313a19a39c264709794b00d25))
...
- Cancel superseded CI runs on main as well as on pull requests (by @ChristopherVR) ([f04a210](https://github.com/ChristopherVR/pptx-viewer/commit/f04a210f7ff0d12608b9227652fe31a734257971))
...
- **shared:** Model relaxedInset/slope/hardEdge as non-monotonic bevel profiles (by @ChristopherVR) ([e3ef9fb](https://github.com/ChristopherVR/pptx-viewer/commit/e3ef9fb33bd991d93153daee3876aebf575128a8))
...
- **zh:** Translate the slide-transition internals sections (by @ChristopherVR) ([2156405](https://github.com/ChristopherVR/pptx-viewer/commit/215640535c2dd0ce54ed29307e0c33bea12429db))
...
- **e2e:** Check the alphaModFix filter per image, not page-wide (by @ChristopherVR) ([051f053](https://github.com/ChristopherVR/pptx-viewer/commit/051f0533cc737733a657cbd02c366f8eebfc23f7))
...
- **e2e:** Retire the closed large-3D-transform foreignObject gap (by @ChristopherVR) ([aae4e68](https://github.com/ChristopherVR/pptx-viewer/commit/aae4e6808d24fe004c38507add4b8cde9b862e71))
...
- **vue:** CSS not matching React (by @ChristopherVR) ([ae13af1](https://github.com/ChristopherVR/pptx-viewer/commit/ae13af152692fb687444a465f8d0b9da3e90a60b))
- **vanilla:** CSS not matching React (by @ChristopherVR) ([352a654](https://github.com/ChristopherVR/pptx-viewer/commit/352a654bae27ef1d2da9247d01589d735ea62b7b))
...
- **deps:** Bump lucide from 1.46.0 to 1.44.0 (by @dependabot[bot]) ([a516c68](https://github.com/ChristopherVR/pptx-viewer/commit/a516c682a15cc85b5537002003eade5be523d484))
- **deps:** Bump @lucide/svelte from 1.46.0 to 1.44.0 (by @dependabot[bot]) ([ad597e5](https://github.com/ChristopherVR/pptx-viewer/commit/ad597e57f9a6ccd482ea0a739d48089c6d406482))
- **deps:** Bump lucide-react from 1.45.0 to 1.44.0 (by @dependabot[bot]) ([5276d48](https://github.com/ChristopherVR/pptx-viewer/commit/5276d483aec89149e7196822824881eec65e6c4d))
...
- **deps-dev:** Bump @vitest/coverage-v8 from 4.1.11 to 5.0.0 (by @dependabot[bot]) ([bf964ec](https://github.com/ChristopherVR/pptx-viewer/commit/bf964ecc6e54759f17a00cc6a0a28fcde12c20bd))
...
- **deps-dev:** Update vite requirement from ^8.2.2 to ^8.3.0 (by @dependabot[bot]) ([79f3bbe](https://github.com/ChristopherVR/pptx-viewer/commit/79f3bbefa3d9e67fa33d80efed7c323679b3c1de))
- **deps-dev:** Update @angular/build requirement (by @dependabot[bot]) ([a95c7eb](https://github.com/ChristopherVR/pptx-viewer/commit/a95c7eb49ad56c9a7169d818d2aabaa85ff952d3))
- **deps-dev:** Update lint-staged requirement from ^17.5.0 to ^17.5.1 (by @dependabot[bot]) ([0ba7415](https://github.com/ChristopherVR/pptx-viewer/commit/0ba741579eed1592e0c0962a37573359bf01d459))
...
_Releases: pptx-viewer-core@3.14.0, pptx-react-viewer@3.16.0, pptx-vue-viewer@3.16.0, pptx-angular-viewer@3.16.0, pptx-vanilla-viewer@2.16.0, pptx-svelte-viewer@3.17.0, pptx-viewer-mcp@2.5.1, @christophervr/pptx-viewer@2.13.2_
...
- **vanilla:** Give the AI composer send button its 44px touch target (by @ChristopherVR) ([b9bbe73](https://github.com/ChristopherVR/pptx-viewer/commit/b9bbe73f188d76594e127e02018f145d7cef81e1))
...
- State each limitation as the gap and its reason, move provenance to the reference pages (by @ChristopherVR) ([721c0c5](https://github.com/ChristopherVR/pptx-viewer/commit/721c0c5104ac994ee28f25d2ccc2ccecd714ddc7))
- Reduce the remaining limitation rows to a status and two sentences (by @ChristopherVR) ([390dbeb](https://github.com/ChristopherVR/pptx-viewer/commit/390dbebde9c0a6cbe047c7c94a6187b2e1bfc46e))
...
- **e2e:** Pin the measured foreignObject gap on large CSS 3-D transforms (by @ChristopherVR) ([7f257e2](https://github.com/ChristopherVR/pptx-viewer/commit/7f257e2aafb8bd267151770349ff2b65c327942d))

## 2026-09-10

_Releases: pptx-viewer-core@3.13.0, pptx-react-viewer@3.15.0, pptx-vue-viewer@3.15.0, pptx-angular-viewer@3.15.0, pptx-vanilla-viewer@2.15.0, pptx-svelte-viewer@3.16.0, @christophervr/pptx-viewer@2.13.1_
...
- Measure PowerPoint's own 97-2003 ceiling for ink, 3D models and SmartArt (by @ChristopherVR) ([514f694](https://github.com/ChristopherVR/pptx-viewer/commit/514f694b6f855c0b7bfd4b8009ee3423dca64ae2))

### Testing

- **e2e:** Expect the metal/circle bevel to use the SVG lighting filter (by @ChristopherVR) ([09ff9d3](https://github.com/ChristopherVR/pptx-viewer/commit/09ff9d30b31c7b9cd279cd5b6dc85317b35e881e))
...
- **vanilla:** Keep rich text runs inline while editing ([#223](https://github.com/ChristopherVR/pptx-viewer/issues/223)) (by @Sudhansh6) ([45ec48c](https://github.com/ChristopherVR/pptx-viewer/commit/45ec48ce290368856b52da5bdd4df1c72eb273b9))
...
- Split the e2e matrix six ways per binding (by @ChristopherVR) ([26a22dc](https://github.com/ChristopherVR/pptx-viewer/commit/26a22dcd0cb8b253229f540382faf9d66ebd0325))
...
- **locales:** Theme colour picker and chart formatting strings (by @ChristopherVR) ([db08ebc](https://github.com/ChristopherVR/pptx-viewer/commit/db08ebc8338c34ac72ee4ec0090bc7db95bd1488))
...
- **vanilla:** Wave-3 parity (staged SmartArt reveal, theme swatches, u=words) (by @ChristopherVR) ([2099fc6](https://github.com/ChristopherVR/pptx-viewer/commit/2099fc63739a6d4020cef827e4a7e685f6cecb52))
...
- **vanilla:** Honour p:seq nextAc="seek" on a mid-flight click (by @ChristopherVR) ([91fb0e8](https://github.com/ChristopherVR/pptx-viewer/commit/91fb0e8689d8b36eef87a78e63491abb1031045a))
...
- Wave-3 parity status and 67 MCP tools (by @ChristopherVR) ([9f6b31f](https://github.com/ChristopherVR/pptx-viewer/commit/9f6b31f3bfb677cdc7e75c386daeff7ab2adf73f))

### Testing

- **e2e:** Wave-3 cross-binding specs (by @ChristopherVR) ([7a6365d](https://github.com/ChristopherVR/pptx-viewer/commit/7a6365d0998192194aac1ac4483ceb48052e70f8))
- **e2e:** Pin nextAc="seek" fast-forward across all five bindings (by @ChristopherVR) ([361a423](https://github.com/ChristopherVR/pptx-viewer/commit/361a4230e171a8d42d6322a49bb6357cea03388b))
