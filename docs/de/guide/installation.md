...
| KI / MCP-Werkzeuge        | `pptx-viewer-mcp`     | 73 MCP-Tools + CLI + Y.Doc-Codec                                |
...
73 PPTX-Manipulations-Tool-Funktionen, ein MCP-Server fur KI-Agenten und der Y.Doc-Zusammenarbeit-Codec.
