...
- **Diagramme:** Wenn Kreisdiagrammbeschriftungen außerhalb des Kreises an der Position `bestFit` kollidieren, schiebt PowerPoint sie auseinander und zeichnet Führungslinien zu den verschobenen; das ist nicht nachgebildet. Ein Kreisdiagramm mit automatischer Zeichnungsfläche wird außerdem etwas größer gezeichnet als in PowerPoint (bei einem kleinen Diagramm bis zu etwa 8 %).
