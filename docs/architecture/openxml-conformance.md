...
| ...and every shape's x/y/w/h within 1% of the diagram's bounds | 82 of 229        |
| ...within 5%                                                   | 105 of 229       |
| ...within 10%                                                  | 117 of 229       |
| ...within 50%                                                  | 178 of 229       |
| Same shape preset on every matched shape                       | 204 of 229       |
| Same font size on every matched shape                          | 25 of 229        |
| Full gate (all of the above at 1%)                             | 10 of 229        |

The two structural misses are `segmented-process--hier5` (a `linDir="fromB"` stack whose items switch between two composite templates by `revPos`, rendered as one row of folded boxes) and `bubble-picture-list--hier5` (a preset-specific blank separator paragraph). By gallery category, the share within 1% is: matrix 3/3, pyramid 7/10, cycle 10/17, hierarchy 11/23, relationship 14/35, list 13/40, process 19/48, picture 5/27, and 0 for timeline (7), Meet the Team (6) and Text Card (13).

Introducing `engine-first-allowlist.ts` (55 layouts) moved geometry-within-1% from 39/229 to 82/229 (and within-5% 59->105, within-10% 72->117, within-50% 155->178, preset 190->204, font 24->25) without moving any of the previously-within-1% fixtures out of that band (checked with `gen-smartart-gallery-baseline.ts --compare`, 0 regressions). The full gate stayed at 10/229: most of the newly-accurate fixtures are still blocked by preset or font-size mismatches the geometry fix does not touch.
