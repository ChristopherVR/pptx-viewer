...
| ...and every shape's x/y/w/h within 1% of the diagram's bounds | 39 of 229        |
| ...within 5%                                                   | 59 of 229        |
| ...within 10%                                                  | 72 of 229        |
| ...within 50%                                                  | 155 of 229       |
| Same shape preset on every matched shape                       | 190 of 229       |
| Same font size on every matched shape                          | 24 of 229        |
| Full gate (all of the above at 1%)                             | 10 of 229        |

The two structural misses are `segmented-process--hier5` (a `linDir="fromB"` stack whose items switch between two composite templates by `revPos`, rendered as one row of folded boxes) and `bubble-picture-list--hier5` (a preset-specific blank separator paragraph). By gallery category, the share within 1% is: cycle 9/17, hierarchy 11/23, pyramid 4/10, list 7/40, process 5/48, relationship 2/35, matrix 1/3, and 0 for picture (27), timeline (7), Meet the Team (6) and Text Card (13).
