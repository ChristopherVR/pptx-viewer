...
Measured 2026-09-25 with `scripts/gen-smartart-gallery-baseline.ts` (per-fixture numbers in `smartart-gallery/baseline.json`); the previous column is the 2026-09-24 run the tenth wave below started from:

| Check                                                          | 2026-09-24 | 2026-09-25 |
| -------------------------------------------------------------- | ---------- | ---------- |
| Same set of text-bearing shapes as PowerPoint                  | 228 of 229 | 228 of 229 |
| ...and every shape's x/y/w/h within 1% of the diagram's bounds | 97 of 229  | 126 of 229 |
| ...within 5%                                                   | 128 of 229 | 161 of 229 |
| ...within 10%                                                  | 137 of 229 | 171 of 229 |
| ...within 50%                                                  | 194 of 229 | 217 of 229 |
| Same shape preset on every matched shape                       | 212 of 229 | 222 of 229 |
| Same font size on every matched shape                          | 24 of 229  | 114 of 229 |
| Full gate (all of the above at 1%)                             | 11 of 229  | 97 of 229  |

By gallery category, the share within 1% is now: timeline 7/7, matrix 3/3, pyramid 7/10, Text Card 9/13, cycle 11/17, hierarchy 14/23, process 27/48, list 21/40, relationship 18/35, picture 9/27, Meet the Team 0/6. The twelve fixtures still beyond 50% are Accent Process, Arrow Ribbon, Balance, Chevron List, Process List, Random to Result Process, Spiral Picture, Varying Width List, Vertical Circle List, and three Meet the Team variants.
...
What does hold: the core single-algorithm layouts (Basic Process, Vertical Process, Basic Block List, Basic/Continuous/Multidirectional Cycle, Basic and Diverging Radial, Hierarchy, Horizontal Hierarchy, Basic and Inverted Pyramid, Organization Chart, and since the tenth wave the snake grids and text cards above) reproduce PowerPoint's geometry within 1% on every dataset in the corpus, and 114 of 229 fixtures match every cached font size. Text autofit follows the measured rules (whole-point sizes, the real frame margins and rounded-corner insets, a fixed 0.78 ratio for folded child paragraphs), and org charts are additionally pinned by `smartart-orgchart-genuine-fixture.test.ts` (topology, hanging-tail offset, fan-vs-column choice).

Still open: the per-point engine does not yet size a node from its content (a `lin` child whose height comes from its text, `h refType="primFontSz"`, collapses to nothing), which keeps Vertical Bullet List, Vertical Box List, Horizontal Bullet List, Basic Chevron Process and Sub-Step Process on the legacy interpreter; org-chart assistants, Name and Title and Half Circle Organization Chart, the labelled and table hierarchies, and the Meet the Team cards remain inexact, and 12 of 229 fixtures still deviate by more than 50% of the diagram size. This only affects decks saved without the cached drawing; PowerPoint itself writes one, so it applies to decks from other generators and to live re-layout after a structural edit.
