...
| Hide, lock or remap parts of the viewer UI from code   | [UI Customization](/guide/customization)                                                                                                                                                                                | Recipes on that page: kiosk mode, trimmed ribbon, pinned settings                                              |
...
| **[MCP & Tools](/packages/mcp)**                                                                                       | Agent/automation authors | The MCP server, its 73 tools, and the CLI.                                                  |
