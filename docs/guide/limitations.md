...
| Effect                                                                                      | Status                                         | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3-D shapes and scenes (`a:sp3d` / `a:scene3d`)                                              | Metal materials oversaturate at high elevation | Metal materials oversaturate under high-elevation light rigs because the specular term is coupled to the diffuse elevation (two remediations were tried and measured worse; a full joint re-fit remains open). The relaxedInset/slope/hardEdge bevels used to show a bright-then-dark cross-section the height-map model could not reproduce; that is fixed (2026-09-16) via a non-monotonic height-remap stage fit against the already-COM-measured cross-section curves (not re-verified against a fresh COM render). Everything else in the 3-D model is COM-measured; see [Visual Effect Fidelity](/guide/visual-effects) for the provenance. |
