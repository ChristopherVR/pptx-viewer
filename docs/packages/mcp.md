...
| **Element**               | 11    | `addElement`, `updateElement`, `deleteElements`, `arrangeElements`, `cloneElement`, `setElementAnimation`, `groupElements`, `ungroupElements`, `batchUpdateElements`, `setElementLockT`, `replaceGeometry` |
