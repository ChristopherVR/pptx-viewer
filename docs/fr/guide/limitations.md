...
- **Pas encore pris en charge :** `p14:bounceEnd`, les declencheurs sur un signet de media (ils se chargent comme un declenchement au clic), l'ondulation lettre par lettre au sein d'une construction par paragraphe, et la creation des transitions p15 (elles sont lues quand elles sont presentes dans un fichier, mais leurs options de direction sont ignorees).
