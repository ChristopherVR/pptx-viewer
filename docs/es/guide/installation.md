...
| Herramientas IA / MCP       | `pptx-viewer-mcp`     | 73 herramientas MCP + CLI + codec Y.Doc                          |
...
73 funciones de herramientas de manipulacion PPTX, un servidor MCP para agentes IA y el codec de colaboracion Y.Doc.
