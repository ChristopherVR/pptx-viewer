...
- **Gráficos:** cuando las etiquetas exteriores de un gráfico circular en la posición `bestFit` se solapan, PowerPoint las separa y dibuja líneas guía hacia las desplazadas; eso no se reproduce. Además, un gráfico circular con área de trazado automática se dibuja algo más grande que en PowerPoint (hasta un 8 % aproximadamente en un gráfico pequeño).
